    ...
    <form onSubmit={handleSubmit} className='space-y-6'>
      <div className='grid gap-4 sm:grid-cols-2'>
        <div className='space-y-2'>
          ...
          <Input
            ...
            className="h-14 rounded-xl border-black/20 bg-white text-base"
          />
        </div>
        <div className='space-y-2'>
      ...
      <div className='space-y-2'>
        ...
        <Textarea
          ...
          required
          disabled={isSubmitting}
          className="rounded-xl border-black/20 bg-white text-base p-4"
        />
      </div>
      ...
      <div className='flex justify-end'>
        <Button
          ...
          size='lg'
          disabled={isSubmitting}
          className='w-full sm:w-auto h-14 px-8 rounded-xl font-bold uppercase tracking-wide'
        >
          {isSubmitting ? (
            <>
