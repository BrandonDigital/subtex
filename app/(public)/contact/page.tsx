      ...
      <div className="py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">Contact Subtex - ACM Sheets Perth</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Have questions about our ACM sheets or need a custom quote for your signage or cladding project? 
              We&apos;re here to help. Contact our Perth team today.
            </p>
          </div>
            ...
            <div className="space-y-6">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <address className="text-sm text-muted-foreground mt-1 not-italic">
                        ...
                        {siteConfig.business.address.suburb}, {siteConfig.business.address.city}<br />
                        {siteConfig.business.address.state} {siteConfig.business.address.postcode}, {siteConfig.business.address.country}
                      </address>
                      <a
              ...
              <Card className="bg-primary/5 border-primary/20">
                <CardContent className="pt-6">
                  <h3 className="font-semibold mb-2">Click & Collect Available in Perth</h3>
                  <p className="text-sm text-muted-foreground">
                    Order ACM sheets online and collect from our Canning Vale warehouse. A holding
                    fee applies for reservations, with the balance payable on pickup.
                    See our{" "}
